...
public class OaiPmhListMetadataFormats extends OaiPmhList implements OaiPmhListBuilder {

    public OaiPmhListMetadataFormats(Document oaiPmhTemplate) {
    ...
    private void addList() throws NotFound {
        Collection<Format> formats = formatService.findAll();
        ...
        if (!formats.isEmpty()) {
            ...
            for (Format format : formats) {
                ...
                Node importedNode = oaiPmhTemplate.importNode(formatTpl.getDocumentElement(), true);
